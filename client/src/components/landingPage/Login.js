...
export default function Login(props) {
  ...
  return (
    <div className="bg-white flex flex-col justify-items-center items-center py-4 px-4 rounded shadow-md lg:w-3/4 w-full my-7 ml-auto ">
      <h1 className="text-3xl font-bold font-poppins py-5">
        Login
      </h1>
      <div className="flex bg-bgsecondary w-fit justify-between rounded my-7">
        <button
          className={
            Toggle === "Patient"
              ? "py-2 px-8 text-lg font-poppins font-semibold cursor-pointer rounded text-white bg-loginprimary"
              : "py-2 px-8 text-lg font-poppins font-medium text-zinc-400 cursor-pointer rounded bg-indigo-50"
          }
          onClick={() => {
            setToggle("Patient");
            setUsername("");
      ...
      <form className="flex flex-col w-full px-8" onSubmit={handleLogin}>
        ...
        <input
          ...
          name="username"
          id="username"
          className="font-poppins px-3 py-2 bg-indigo-50 rounded outline-none"
          value={username}
        ...
        {Loading ? (
          ...
          <button
            type="submit"
            className="text-lg mt-10 my-7 bg-primary py-1 px-3 rounded font-semibold font-poppins shadow-sm hover:bg-bgsecondary"
            style={{backgroundColor:"#ec4d6d"}}
          >
            Login
          </button>
        )}
